...
| CWA-010 | Publish userscript v2.9.32 to the live Marketplace projection | CWA-006 + existing GitHub Release + protected platform deployment | CWA-R022; exact metadata and live API readback | in-progress / online verified; no-E2E exception | Keep task open under user's no-E2E instruction; client can use live metadata |
