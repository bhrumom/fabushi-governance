...
| FCM-010.11 | Measure latency across the real required/CLI/UI/package validation surfaces | yes | schema-v2 observer directly samples current workflows, reports per-surface P50/P95/queue P95/slowest runs, and removes stale historical-job classification | in-progress |
