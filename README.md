# Fabushi — portfolio, migration, and repository governance

Status: repository bootstrap; source migration is pending.

This public repository is the independent home for **portfolio, migration, and repository governance** in the Fabushi platform repository separation project.

- Project: `FAB-P0013` / `PRS`
- Source baseline: `bhrumom/fabushi@cbe65975f3c4c077fa64af4171ebe3d2900185ad`
- Planned source roots: `projects; docs; PRD; .agent; AGENTS.md; .github`
