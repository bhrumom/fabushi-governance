...
源码版本 `2.9.19` 已在 source 仓库完成 PR、exact-main CI 和 Release；parent task record、canonical parent main readback 与已登录 Chrome 的真实分步截图/完整视频/trace/diagnostics 仍按任务门禁跟踪，不以源代码回归替代现场证据。
